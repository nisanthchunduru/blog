...
%o`, message, error2, detail);
  ...
  // assets/js/controllers/theme_controller.ts
  ...
  // assets/js/controllers/menu_controller.ts
  var MenuController = class extends Controller {
    static {
      this.targets = ["dropdown", "backdrop"];
    }
    toggle() {
  ...
  // assets/js/controllers/highlight_controller.ts
  var SCRIPT_URL = "https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.8.0/highlight.min.js";
  var LIGHT_STYLE_URL = "https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.8.0/styles/github.min.css";
  var DARK_STYLE_URL = "https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.8.0/styles/github-dark.min.css";
  var HIGHLIGHT_SCRIPT_ID = "highlightjs-script";
  var HIGHLIGHT_LIGHT_STYLE_ID = "hljs-light";
  var HIGHLIGHT_DARK_STYLE_ID = "hljs-dark";
  ...
  function loadScript() {
    ...
    scriptLoader = new Promise((resolve, reject) => {
      const script = document.getElementById(HIGHLIGHT_SCRIPT_ID);
      if (script) {
  ...
  function ensureStylesheets(theme) {
  ...
  function applyTheme(theme) {
    const light = document.getElementById(HIGHLIGHT_LIGHT_STYLE_ID);
    const dark = document.getElementById(HIGHLIGHT_DARK_STYLE_ID);
